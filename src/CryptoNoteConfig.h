...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = ax4f;
...
const char     CRYPTONOTE_NAME[]                             = "AMAZONCASH";
...
const int      P2P_DEFAULT_PORT                              = 5991;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 6091;
